...
DEFAULT_REQUIREMENTS = {
    "Software Engineer": {
        ...
        "education": {
            ...
            "alternative_majors": ["Mathematics", "Physics", "Electronics"],
        ...
        "certifications": {
            ...
            "nice_to_have": ["Scrum Master", "TOGAF", "ITIL"],
    ...
    "Frontend Developer": {
        ...
        "education": {
            ...
            "alternative_majors": ["Graphic Design", "Digital Media"],
            "bootcamp_acceptable": True,
            "weight": 10,
        },
        "certifications": {
            ...
            "nice_to_have": ["Adobe Certified Expert", "UI/UX Design Certificate"],
            "weight": 5,
        },
        "soft_skills": {
            "required": [
            ...
            "preferred": ["UI/UX mindset", "Design thinking", "Agile methodology"],
            "weight": 10,
        },
        "scoring": {
            "min_pass_score": 55,
    ...
    with tab1:
        ...
        if not positions:
            ...
            if selected_position:
                ...
                st.write(
                    f"**Preferred Majors:** {', '.join(edu.get('preferred_majors', []))}"
                )
                st.write(
                    f"**Bootcamp Acceptable:** {' Yes' if edu.get('bootcamp_acceptable') else ' No'}"
                )
                ...
                with col3:
                    st.metric(
                        "Auto Reject", f"< {scoring.get('auto_reject_below', 40)}"
                    )
                with col4:
                    st.metric(
                        "Auto Interview", f"> {scoring.get('auto_interview_above', 85)}"
                    )
        ...
        with st.form("position_form"):
            ...
            with col1:
                required_skills = st.text_area(
                    ...
                    value="\n".join(
                        [
                            skill
                            for skills in base_req.get("technical_skills", {})
                            .get("required", {})
                            .values()
                            for skill in skills
                        ]
            ...
            with col2:
                submitted = st.form_submit_button(
                    " Lưu Cấu Hình", use_container_width=True, type="primary"
                )
